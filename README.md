...
## Flask apps
- Tree viewer (read-only): `uv run flask --app src.flask.tree.show_tree run --debug` → http://127.0.0.1:5000  
- Gloss CRUD UI: `uv run flask --app src/flask/gloss-crud/app.py run --debug` → http://127.0.0.1:5000
